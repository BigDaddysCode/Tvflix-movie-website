...
![Tvflix](https://github.com/BigDaddysCode/Tvflix-movie-website)
...
Check out the live demo [here](https://github.com/BigDaddysCode/Tvflix-movie-website)
...
1. Clone the repository.
 [  ```bash
   ```](https://github.com/BigDaddysCode/Tvflix-movie-website)
